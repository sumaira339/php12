                                    ...
                                    <div class="card-body">
                                        <form class="forms-sample" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="pnamee" value="<?=$row ['pname']?>"/>
                                            <div class="form-group">
                                                <label for="exampleInputtext1">Product Code</label>
                                                <input type="text" class="form-control" id="exampleInputtext1" name="pcodee" value="<?=$row ['pcode']?>"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Price ($)</label>
                                                <input type="number" class="form-control" id="exampleInputPassword1" name="pricee"  value="<?=$row ['price']?>"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputConfirmPassword1">Warranty</label>
                                                <input type="text" class="form-control" id="exampleInputConfirmPassword1" name="warrantyy" value="<?=$row ['warranty']?>"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputConfirmPassword1">Quantity</label>
                                                <input type="text" class="form-control" id="exampleInputConfirmPassword1"  name="Quantityy" value="<?=$row ['Quantity']?>"/>
                                            </div>
